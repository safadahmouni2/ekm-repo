...
import vwg.vw.km.integration.persistence.dao.BrandDAO;
 ...
 */
public class BrandManagerImpl extends DBManagerImpl<BrandModel, BrandDAO> implements BrandManager {
	 ...
	 */
	public Serializable getObjectPK(BrandModel model) {
