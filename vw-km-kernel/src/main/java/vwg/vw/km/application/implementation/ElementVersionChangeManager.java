 ...
 * @version $Revision: 1.9 $ $Date: 2019/01/18 15:00:44 $
 */
public interface ElementVersionChangeManager extends BaseManager<ElementVersionChangeModel, ElementVersionChangeDAO> {
	 ...
	 */
	List<ElementVersionChangeModel> getChangesByVersion(Long versionId, ChangeType type);

	List<ElementVersionChangeModel> getChangesByCriteria(SearchHistoryObject searchHistoryObject);

	/**
	 * Method to modify change type for a version it is used when new stand
	 * 
	 * @param versionId
	 * @param fromChangeType
	 * @param toChangeType
	 */
	void updateChangeTypeForVersion(Long versionId, ChangeTypeValue fromChangeType, ChangeTypeValue toChangeType);
