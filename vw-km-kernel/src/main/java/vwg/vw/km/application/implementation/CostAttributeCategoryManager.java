 ...
 * @version $Revision: 1.5 $ $Date: 2011/08/17 10:38:15 $
 */
public interface CostAttributeCategoryManager
		extends BaseManager<CostAttributeCategoryModel, CostAttributeCategoryDAO> {

	/**
	 * 
	 * @param category
	 * @return CostAttributeCategories By Category
	 */
