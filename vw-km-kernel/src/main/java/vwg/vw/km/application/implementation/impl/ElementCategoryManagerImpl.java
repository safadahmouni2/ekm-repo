 ...
 */
public class ElementCategoryManagerImpl extends DBManagerImpl<ElementCategoryModel, ElementCategoryDAO>
		implements ElementCategoryManager {
	 ...
	 */
	public Serializable getObjectPK(ElementCategoryModel model) {
		return model.getElementCategoryId();
	}
