 ...
 * @version $Revision: 1.3 $ $Date: 2011/08/17 10:28:11 $
 */
public class EnumComponentClassManagerImpl extends DBManagerImpl<EnumComponentClassModel, EnumComponentClassDAO>
		implements EnumComponentClassManager {
	 ...
	 */
	public Serializable getObjectPK(EnumComponentClassModel model) {
		return model.getEnumComponentClassId();
	}
