 ...
 * @version $Revision: 1.6 $ $Date: 2011/08/17 10:38:15 $
 */
public interface CostAttributeManager extends BaseManager<CostAttributeModel, CostAttributeDAO> {
	public List<CostAttributeModel> getCostAttributes();

	/**
	 * 
	 * @param pricePerUnit
	 * @return CostAttribute List By PricePerUnit
	 */
