 ...
 */
public interface ElementVersionUsersManager extends BaseManager<ElementVersionUsersModel, ElementVersionUsersDAO> {

	/**
	 * get the list of brand using an element version (Nutzer)
	 * 
	 * @param elementVersionId
	 * @return
	 */
	public List<BrandModel> getBrandsByElement(Long elementId);
