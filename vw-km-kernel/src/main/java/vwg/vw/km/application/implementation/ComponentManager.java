 ...
 */
public interface ComponentManager extends BaseManager<ComponentModel, ComponentDAO> {
	/**
	...
	/**
	 * return component by given number or designation and brand and not the given component id
	 * 
	 * @param componentId
	...
	/**
	 * Check if folder has inactives components
	 * 
	 * @param folderId
	 * @return
	 */
