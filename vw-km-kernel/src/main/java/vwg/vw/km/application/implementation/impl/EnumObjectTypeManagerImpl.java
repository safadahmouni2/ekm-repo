 ...
 * @version $Revision: 1.5 $ $Date: 2011/08/17 10:28:11 $
 */
public class EnumObjectTypeManagerImpl extends DBManagerImpl<EnumObjectTypeModel, EnumObjectTypeDAO>
		implements EnumObjectTypeManager {
	 ...
	 */
	public Serializable getObjectPK(EnumObjectTypeModel model) {
		return model.getEnumObjectTypeId();
	}
