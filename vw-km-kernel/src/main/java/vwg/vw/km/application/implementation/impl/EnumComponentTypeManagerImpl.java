...
import vwg.vw.km.integration.persistence.dao.EnumComponentTypeDAO;
 ...
 */
public class EnumComponentTypeManagerImpl extends DBManagerImpl<EnumComponentTypeModel, EnumComponentTypeDAO>
		implements EnumComponentTypeManager {
	 ...
	 */
	public Serializable getObjectPK(EnumComponentTypeModel model) {
		return model.getEnumComponentTypeId();
	}
