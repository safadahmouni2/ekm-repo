 ...
 * @version $Revision: 1.4 $ $Date: 2019/01/18 15:00:44 $
 */
public interface ComponentStandChangeManager extends BaseManager<ComponentStandChangeModel, ComponentStandChangeDAO> {

	/**
	 * get the aggregated changes for the last versions
	 * 
	 * @param cmpVersionList
	 *            list of versions
	 * @return
	 */
	List<ComponentStandChangeModel> getAggregatedChangesByVersions(List<ComponentVersionModel> cmpVersionList);
