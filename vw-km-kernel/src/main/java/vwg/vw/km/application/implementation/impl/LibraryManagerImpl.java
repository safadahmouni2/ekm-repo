...
import vwg.vw.km.integration.persistence.dao.LibraryDAO;
 ...
 * @version $Revision: 1.1 $ $Date: 2012/08/27 07:52:31 $
 */
public class LibraryManagerImpl extends DBManagerImpl<LibraryModel, LibraryDAO> implements LibraryManager {
	 ...
	 */
	public Serializable getObjectPK(LibraryModel model) {
		return model.getLibraryId();
	}
