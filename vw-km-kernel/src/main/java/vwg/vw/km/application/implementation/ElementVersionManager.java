 ...
 */
public interface ElementVersionManager extends BaseManager<ElementVersionModel, ElementVersionDAO> {
	 ...
	 * @return
	 */
	public ElementVersionModel getLastElementVersionByStatus(Long elementId, Long status);
	...
	/**
	 * load componentVersion dependent ElementValues,CostAttributeCategories
	 * 
	...
	/**
	 * calculate totalAmount for each ElementValueModel attached to the elementVersion
	 * 
	 * @param elementVersion
	 */
