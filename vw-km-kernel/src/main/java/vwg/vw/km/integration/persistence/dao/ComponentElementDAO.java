 ...
 * @version $Revision: 1.13 $ $Date: 2013/12/10 11:40:19 $
 */
public interface ComponentElementDAO extends BaseDao<ComponentElementModel> {
	 ...
	 */
	public List<ComponentElementModel> getComponentElementListByComponentStandId(Long componentVersionId);
