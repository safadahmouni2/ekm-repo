 ...
 * @version $Revision: 1.7 $ $Date: 2011/08/17 10:27:37 $
 */
public class DocumentPoolDAOImpl extends DBDaoImpl<DocumentPoolModel> implements DocumentPoolDAO {

	/**
	 * @see vwg.vw.km.integration.persistence.dao.impl.base.DBDaoImpl#getBusinessClass()
	 */
	@Override
	protected Class<DocumentPoolModel> getBusinessClass() {
		return DocumentPoolModel.class;
	}
}
