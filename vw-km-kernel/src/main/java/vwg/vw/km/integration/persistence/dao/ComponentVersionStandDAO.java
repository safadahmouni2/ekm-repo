 ...
 */
public interface ComponentVersionStandDAO extends BaseDao<ComponentStandModel> {
	 ...
	 * 
	 * @param Map
	 *            <BrandModel, List<ElementModel>> elementByBrand
	 * @return a List of componentVersionStand object
	 */
	public List<ComponentStandModel> getComponentVersionStandByNotOwnerLinkedElement(
			Map<BrandModel, List<ElementModel>> elementByBrand);
