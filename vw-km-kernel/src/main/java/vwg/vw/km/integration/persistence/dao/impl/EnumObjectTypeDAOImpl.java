 ...
 */
public class EnumObjectTypeDAOImpl extends DBDaoImpl<EnumObjectTypeModel> implements EnumObjectTypeDAO {

	/**
	 * @see vwg.vw.km.integration.persistence.dao.impl.base.DBDaoImpl#getBusinessClass()
	 */
	@Override
	protected Class<EnumObjectTypeModel> getBusinessClass() {
		return EnumObjectTypeModel.class;
	}
