 ...
 * @version $Revision: 1.6 $ $Date: 2011/08/17 07:01:02 $
 */
public interface HourlyRateDAO extends BaseDao<HourlyRateModel> {

	/**
	 * get HourlyRate By CostAttribute And Catalog
	 * 
	 * @param costAttributeId
	 * @param catalogId
	 * @return
	 */
	...
	/**
	 * get HourlyRate List By Catalog
	 * 
	 * @param catalogId
	 * @return
	 */
