 ...
 * @version $Revision: 1.3 $ $Date: 2013/11/04 08:52:50 $
 */
...
public interface TableSpaceStatisticDAO {

	/**
	 * return list of TableSpaceStatisticModel
	 * 
	 * @return List<TableSpaceStatisticModel>
	 */
