 ...
 */
public class EnumComponentTypeDAOImpl extends DBDaoImpl<EnumComponentTypeModel> implements EnumComponentTypeDAO {

	/**
	 * @see vwg.vw.km.integration.persistence.dao.impl.base.DBDaoImpl#getBusinessClass()
	 */
	@Override
	protected Class<EnumComponentTypeModel> getBusinessClass() {
		return EnumComponentTypeModel.class;
	}
	...
	protected String getCacheRegion() {
		return "query.enumComponentType";
	}
