 ...
 * @version $Revision: 1.41 $ $Date: 2014/01/21 08:36:36 $
 */
public class CostComponentFolderNode extends ComponentFolderNode {

	private final Log log = LogManager.get().getLog(CostComponentFolderNode.class);

	public CostComponentFolderNode(NavigationBean tree, FolderNode parent, String category, Long folderId) {
