 ...
 */
public class WorkingComponentFolderNode extends WorkingUserComponentFolderNode {

	public WorkingComponentFolderNode(NavigationBean tree, FolderNode parent, String name, Long folderId,
			Long workingUserId) {
