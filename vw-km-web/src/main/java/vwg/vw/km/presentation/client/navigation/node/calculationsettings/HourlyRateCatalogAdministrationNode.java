 ...
 * @version $Revision: 1.31 $ $Date: 2013/12/12 10:05:41 $
 */
public class HourlyRateCatalogAdministrationNode extends CatalogFolder {

	public HourlyRateCatalogAdministrationNode(NavigationBean tree, FolderNode parent) {
		super(tree, parent, 5L);
		setContextMenu(ContextMenuEnum.CatalogFolderAdministrationObjectContextMenu);
	...
	public List<Node> getChilds() {
		...
		for (HourlyRateCatalogModel hModel : list) {
			HourlyRateCatalogNode n = new HourlyRateCatalogNode(treeBean, this, hModel.getDesignation(),
					hModel.getHourlyRateCatalogId());
			childs.add(n);
			objectChildsCount++;
