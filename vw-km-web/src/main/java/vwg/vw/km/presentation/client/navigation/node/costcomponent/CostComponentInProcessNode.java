 ...
 * @version $Revision: 1.30 $ $Date: 2014/03/05 17:09:43 $
 */
public class CostComponentInProcessNode extends SearchFolderNode {

	private final Log log = LogManager.get().getLog(CostComponentInProcessNode.class);

	public CostComponentInProcessNode(NavigationBean tree, FolderNode parent) {
		super(tree, parent, StaticNodeIdEnum.COST_COMPONENT_IN_PROCESS_NODE.value());
