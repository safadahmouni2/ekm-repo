...
public class CalculatorModuleRootNode extends StaticFolderNode {
	...
	public CalculatorModuleRootNode(NavigationBean tree) {
		super(tree, null, StaticNodeIdEnum.CALCULATOR_MODULE_ROOT_NODE.value());
	...
	public List<Long> getRightIds() {
		...
		rights.add(RoleManager.Right.MANAGE_CALCULATOR_MODULE.value());
		return rights;
	}
